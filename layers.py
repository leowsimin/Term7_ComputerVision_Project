...
class TransformerBlock(tf.keras.layers.Layer):
    def __init__(self, patch_size, num_patches, embed_dim, num_heads, mlp_hidden_dim):
    ...
    def call(self, images):
        ...
        # Positional Embedding
        embedded_patches_with_position = patch_embeddings + self.positional_embedding

        # T-Block Operations
        attn_output = self.attention(self.norm1(embedded_patches_with_position))
        x = embedded_patches_with_position + attn_output
